"""
Django settings for launchtracker project.
...
ROOT_URLCONF = 'launchtracker.urls'
...
WSGI_APPLICATION = 'launchtracker.wsgi.application'
...
LOGIN_REDIRECT_URL = 'launch-index'
